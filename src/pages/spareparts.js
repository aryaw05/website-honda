function Sparepart() {
  const data = [
    {
      ...
      Harga: 14.5,
      Gambar:
        "https://www.hondacengkareng.com/produk/cover-r-step-arm-inner-50731k97t00za/",
    },
    {
      "Nama barang":
  ...
  return (
    <div>
      <h1 className="text-center my-5">Sparepart</h1>
          ...
          <div className=" col-md-2 ">
            ...
            >
              ...
              <div className="card-body">
                <p className="card-text">{item["Nama barang"]}</p>
                <h2 className="card-text">{item.Harga}</h2>
              </div>
            </div>
          </div>
        ))}
